...
var $ = v({
    ...
    setup(e, { slots: n }) {
      ...
      return () => r("div", { style: c.value, class: u.value }, q(n.default));
    },
  }),
  j = v({
    name: "QItemSection",
    ...
    setup(e, { slots: n }) {
      ...
      return () => r("div", { class: l.value }, q(n.default));
    },
  }),
  D = v({
    name: "QItem",
    ...
    setup(e, { slots: n, emit: l }) {
      const {
        ...
        s = f(null),
        o = f(null),
        m = a(() => e.clickable === !0 || d.value === !0 || e.tag === "label"),
        i = a(() => e.disable !== !0 && m.value === !0),
        g = a(
          () =>
            "q-item q-item-type row no-wrap" +
            (e.dense === !0 ? " q-item--dense" : "") +
            (c.value === !0 ? " q-item--dark" : "") +
            (d.value === !0 && e.active === null
              ? _.value
              : e.active === !0
              ? ` q-item--active${
        ...
        B = a(() => {
          ...
          const t = u.lang.rtl === !0 ? "Right" : "Left";
          return { ["padding" + t]: 16 + e.insetLevel * 56 + "px" };
        });
      function x(t) {
        i.value === !0 &&
          (o.value !== null &&
            t.qAvoidFocus !== !0 &&
            (t.qKeyEvent !== !0 && document.activeElement === s.value
              ? o.value.focus()
              : document.activeElement === o.value && s.value.focus()),
          y(t));
      }
      function C(t) {
        if (i.value === !0 && R(t, [13, 32]) === !0) {
          K(t), (t.qKeyEvent = !0);
      ...
      function L() {
        ...
        return (
          i.value === !0 &&
            t.unshift(
              r("div", { class: "q-focus-helper", tabindex: -1, ref: o })
            ),
          t
        );
      }
      return () => {
        ...
        return (
          i.value === !0
            ? ((t.tabindex = e.tabindex || "0"), Object.assign(t, k.value))
            : m.value === !0 && (t["aria-disabled"] = "true"),
          r(h.value, t, L())
        );
      };
    },
  });
export { D as Q, j as a, $ as b };
