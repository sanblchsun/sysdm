!(function () {
  ...
  ((e) => {
    ...
    let E,
      S = new WeakMap();
    function init() {
      l.addEventListener("single-file-load-deferred-images-start", () =>
        loadDeferredImagesStart()
      ),
        l.addEventListener(
          "single-file-load-deferred-images-keep-zoom-level-start",
          () => loadDeferredImagesStart(!0)
        ),
        l.addEventListener("single-file-load-deferred-images-end", () =>
          loadDeferredImagesEnd()
        ),
        l.addEventListener(
          "single-file-load-deferred-images-keep-zoom-level-end",
          () => loadDeferredImagesEnd(!0)
        ),
        l.addEventListener(
          "single-file-load-deferred-images-reset",
          resetScreenSize
        ),
        l.addEventListener(
        ...
        l.addEventListener("single-file-request-fetch-supported", () =>
          l.dispatchEvent(new s("single-file-response-fetch-supported"))
        ),
        l.addEventListener("single-file-request-fetch", async (e) => {
          const { url: t, options: n } = u.parse(e.detail);
          let i;
          try {
            const e = await o(t, n);
            i = {
              url: t,
              response: await e.arrayBuffer(),
              headers: [...e.headers],
              status: e.status,
            };
          } catch (e) {
            i = { url: t, error: e && (e.message || e.toString()) };
          }
          l.dispatchEvent(new s("single-file-response-fetch", { detail: i }));
        }),
        l.addEventListener(i, getAdoptedStylesheetsListener),
    ...
    function loadDeferredImagesStart(i) {
          ...
          (c.prototype.getBoundingClientRect = function () {
            ...
            return (
              this == r &&
                ...
                t.__defineGetter__("width", () => p),
                t.__defineGetter__("right", () => p + t.left)),
              t
            );
          })),
        !e._singleFileImage)
            ...
            return function () {
              ...
              return (
                i.__defineSetter__("src", (t) => {
                  (e.src = t), l.dispatchEvent(new s(n, { detail: e.src }));
                }),
                i.__defineGetter__("src", () => e.src),
                i.__defineSetter__("srcset", (t) => {
                  l.dispatchEvent(new s(n)), (e.srcset = t);
                }),
                ...
                (e.onload =
                  ...
                  e.onerror =
                    (t) => {
                      l.dispatchEvent(
                        new s("single-file-image-loaded", { detail: e.src })
                      ),
                        i.dispatchEvent(new g(t.type, t));
                    }),
                i
              );
            };
      ...
      i
        ? ((u = o / f), (m = d / p))
        : ((u = (o + e.scrollY) / f), (m = (d + e.scrollX) / p));
      const h = Math.min(u, m);
      if (h < 1) {
        ...
        e.window == e.window.top &&
          [...y].forEach(([e, n]) => {
            ...
            if (o) {
              ...
              s.length && n.callback.call(e, s, e);
            }
          });
      }
    }
    function loadDeferredImagesEnd(n) {
    ...
    if (
      (init(),
      new m(init).observe(l, { childList: !0 }),
      ...
      e.CSS.paintWorklet.addModule = function (n, i) {
        try {
          ...
          return (
            (n = new h(n, l.baseURI).href),
            l.dispatchEvent(
              new s("single-file-new-worklet", {
    ...
    if (e.FontFace) {
      const t = e.FontFace;
      (e.FontFace = function (e, n, ...i) {
        try {
          return new.target
            ? (getDetailObject(e, n, ...i).then((e) =>
                l.dispatchEvent(
                  new s("single-file-new-font-face", { detail: e })
                )
              ),
              new t(e, n, ...i))
            : t();
      ...
      (l.fonts.delete = function (e) {
        try {
          return (
            getDetailObject(e.family).then((e) =>
              l.dispatchEvent(new s("single-file-delete-font", { detail: e }))
            ),
            n.call(l.fonts, e)
          );
        } catch (e) {
      ...
      (l.fonts.clear = function () {
        try {
          return (
            l.dispatchEvent(new s("single-file-clear-fonts")), i.call(l.fonts)
          );
        } catch (e) {
          throw (
            ((e.stack =
          ...
          return (
            n &&
              ((e.observe = function (t) {
                try {
                  let i = v.get(e);
                  return i || ((i = []), v.set(e, i)), i.push(t), n.call(e, t);
                } catch (e) {
                  throw (
                    ((e.stack =
                      e.message +
            ...
            i &&
              ((e.unobserve = function (t) {
                try {
                  ...
                  return (
                    n &&
                      ((n = n.filter((e) => e != t)),
                      n.length ? v.set(e, n) : (v.delete(e), y.delete(e))),
                    i.call(e, t)
                  );
                } catch (e) {
                  throw (
              ...
              (e.unobserve.toString = function () {
                return "function unobserve() { [native code] }";
              })),
            y.set(e, { callback: r, options: o }),
            e
          );
        } catch (e) {
          throw (
    ...
    const w = _.prototype.replaceSync;
    (_.prototype.replaceSync = function (e) {
      try {
        const t = w.apply(this, [e]);
        return S.set(this, e), t;
      } catch (e) {
        throw (
          ((e.stack =
            e.message +
      ...
      (_.prototype.replaceSync.toString = function () {
        return "function replaceSync() { [native code] }";
      });
    const b = _.prototype.replace;
    (_.prototype.replace = async function (e) {
      try {
        const t = await b.apply(this, [e]);
        return S.set(this, e), t;
      } catch (e) {
        throw (
          ((e.stack =
      ...
      (_.prototype.replace.toString = function () {
        return "function replace() { [native code] }";
      });
    const k = _.prototype.insertRule;
    (_.prototype.insertRule = function (e, t) {
      try {
        const n = k.apply(this, [e, t]);
        return S.delete(this), n;
      } catch (e) {
        throw (
          ((e.stack =
            e.message +
      ...
      (_.prototype.insertRule.toString = function () {
        return "function insertRule() { [native code] }";
      });
    const F = _.prototype.deleteRule;
    function getAdoptedStylesheetsListener(e) {
      const t = e.target.shadowRoot;
      if ((e.stopPropagation(), t)) {
        t.addEventListener(i, getAdoptedStylesheetsListener, { capture: !0 }),
          t.addEventListener(
            "single-file-unregister-request-get-adopted-stylesheets",
            () => {
              t.removeEventListener(i, getAdoptedStylesheetsListener);
            },
            { once: !0 }
          );
        ...
        e.length &&
          t.dispatchEvent(
            new s("single-file-response-get-adopted-stylesheets", {
              detail: { adoptedStyleSheets: e },
            })
          );
      }
    }
    async function getDetailObject(e, t, n) {
      const i = {};
      return (
        (i["font-family"] = e),
        (i.src = t),
    ...
    function dispatchResizeEvent() {
      try {
        e.dispatchEvent(new d("resize")), E && e.dispatchEvent(new d("scroll"));
      } catch (e) {}
    }
    (_.prototype.deleteRule = function (e) {
      try {
        const t = F.apply(this, [e]);
        return S.delete(this), t;
      } catch (e) {
        throw (
          ((e.stack =
            e.message +
      ...
      (_.prototype.deleteRule.toString = function () {
        return "function deleteRule() { [native code] }";
      });
  })("object" == typeof globalThis ? globalThis : globalThis.window);
})();
